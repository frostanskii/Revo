(() => {
    ...
    function initSliders() {
        if (document.querySelector(".favorite-slider1")) var favoriteSlider1 = new core(".favorite-slider1", {
            modules: [ Navigation, Grid, Controller ],
            observer: true,
            observeParents: true,
            spaceBetween: 32,
            autoHeight: false,
        ...
        if (document.querySelector(".favorite-slider2")) var favoriteSlider2 = new core(".favorite-slider2", {
            modules: [ Controller ],
            observer: true,
            observeParents: true,
            spaceBetween: 32,
        ...
        favoriteSlider2.controller.control = favoriteSlider1;
        favoriteSlider1.controller.control = favoriteSlider2;
        if (document.querySelector(".combo__slider")) new core(".combo__slider", {
            modules: [ Navigation, Grid, Controller ],
            observer: true,
            observeParents: true,
            spaceBetween: 30,
